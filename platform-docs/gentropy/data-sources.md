...
Studies identified as exome- or whole-genome sequencing analyses through the `ExWAS` or `wgsGWAS` analysis flags use sequencing-specific QC thresholds. The default thresholds remain unchanged for all other studies. For sequencing studies:

* the **P–Z test** is skipped;
* the absolute mean beta threshold is increased  to 1.0;
* the accepted genomic control lambda range is expanded to \[0.1, 2.5];
* the minimum expected number of variants is reduced to 1,000,000.

These thresholds reflect the different properties of sequencing studies, which test rare variants with larger effect sizes, and often use methods for which reported p-values do not correspond directly to beta-derived Z-scores.
...
This includes data generated by Open Targets projects:

* [Jerber, Seaton, Cuomo, et al. 2021 (HipSci)](https://doi.org/10.1038/s41588-021-00801-6): Single-cell eQTLs from iPSC-derived dopaminergic neurons across differentiation stages and oxidative stress across 194 donors&#x20;
* [Young, Kumasaka, et al. 2021](https://doi.org/10.1038/s41588-021-00875-2): Bulk eQTLs from primary human microglia isolated from adult neurosurgical tissue across 104 donors.
* [Soskic, Cano-Gamez, et al. 2022 (Cytoimmgen)](https://doi.org/10.1038/s41588-022-01066-3): Single-cell eQTLs from stimulated naive and memory CD4<sup>+</sup> T cells from 119 donors.
* [Alegbe, Harris, et al. 2026 (IBDverse)](https://doi.org/10.1038/s41586-026-10627-z): Single-cell eQTLs generated using gastrointestinal tissue and blood from 296 healthy and 125 IBD-afflicted donors.
