...
* The **Biobank Rare Variant Analysis (BRaVa) Consortium** (Palmer et al., 2026), a global rare variant association resource integrated across 10 biobanks comprising over 1.2 million individuals across diverse ancestry groups.
* The results from **Genes & Health** (Kim et al., 2026), a study of over 44,000 British-Pakistani and Bangladeshi individuals.
